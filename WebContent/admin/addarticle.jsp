				...
				<div class="widget" style="width: 65%; margin: 0 auto;">
					...
					<div class="widgetcontent nopadding">
						<form class="stdform stdform2" method="post" action="article/addArticle.action" name="myform" method="post">
							...
							<p>
								<label>栏目</label><span class="field"><select name="bannerid" class="input-xxlarge" style="width: 430px;" id="bannerid"><option
											value="">---请选择栏目--</option>
							...
							<p>
								<label>图片</label><span class="field"><input class="input-xxlarge" style="width: 430px;" type="text" name="image" id="image"
									onclick="selimage();" placeholder="请选择图片" readonly="readonly" /></span>
							</p>
							<p>
