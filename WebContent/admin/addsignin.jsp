		...
		<div class="maincontent">
			<div class="maincontentinner">
				<div class="widget" style="width: 65%; margin: 0 auto;">
					<h4 class="widgettitle">新增学生签到</h4>
					<div class="widgetcontent nopadding">
						<form class="stdform stdform2" method="post" action="signin/addSignin.action" name="myform" method="post">

							<p>
								<label>学生用户</label><span class="field"><select name="usersid" class="input-xxlarge" style="width: 430px;" id="usersid"><option
											value="">---请选择学生用户--</option>
