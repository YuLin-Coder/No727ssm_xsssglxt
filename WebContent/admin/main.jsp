	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top">
				...
				</a><span class="index_top"><strong>欢迎使用学生宿舍管理系统</strong></span>
				<span style="position: fixed;right: 70px;top: 18px;color: white;">欢迎您：${sessionScope.adminname=="admin" ? "系统管理员" : "宿舍管理员" }</span>
