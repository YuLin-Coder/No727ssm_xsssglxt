				...
				<div class="widget" style="width: 50%; margin: 0 auto;">
					...
					<div class="widgetcontent nopadding">
						<form class="stdform stdform2" method="post" action="admin/editpwd.action" name="myform" method="post">
							...
							<p>
								<label>密码</label> <span class="field"><input type="password" name="password" class="input-xxlarge" id="password"
									placeholder="请输入密码" /></span>
							</p>
							<p>
								<label>新密码</label> <span class="field"><input type="password" name="newpassword" class="input-xxlarge" id="newpassword"
									placeholder="请输入新密码" /></span>
							</p>
							<p>
								<label>确认密码</label> <span class="field"><input type="password" name="repassword" class="input-xxlarge" id="repassword"
									placeholder="请输入确认密码" /></span>
							</p>
