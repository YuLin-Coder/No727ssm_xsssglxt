				...
				<div class="widget" style="width: 65%; margin: 0 auto;">
					...
					<div class="widgetcontent nopadding">
						<form class="stdform stdform2" method="post" action="article/updateArticle.action" name="myform" method="post">
							...
							<p>
								<label>标题</label><span class="field"><input type="text" name="title" class="input-xxlarge" style="width: 430px;" id="title"
									value="${article.title}" /></span>
							</p>
							<p>
								<label>栏目</label><span class="field"><select name="bannerid" class="input-xxlarge" style="width: 430px;" id="bannerid"><c:forEach
							...
							<p>
								<label>图片</label><span class="field"><input class="input-xxlarge" style="width: 430px;" type="text" name="image"
									value="${article.image}" id="image" onclick="selimage();" readonly="readonly" /></span>
							</p>
							<p>
								<label>是否置顶</label><span class="field"><input type="radio" name="istop" value="是" title="是" ${article.istop == "是"?"checked":""}>是
									&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="istop" value="否" title="否" ${article.istop == "否"?"checked":""}>否</span>
							</p>
							<p>
								<label>是否轮播</label><span class="field"><input type="radio" name="isflv" value="是" title="是" ${article.isflv == "是"?"checked":""}>是
									&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="isflv" value="否" title="否" ${article.isflv == "否"?"checked":""}>否</span>
							</p>
							<p>
