	...
	<div class="mainwrapper">
		<div class="maincontent">
			<div class="maincontentinner">
				<h4 class="widgettitle">访客登记查询</h4>
				...
				<div class="dataTables_info" id="dyntable_info" style="text-align: right;">
					<form action="visit/queryVisitByCond.action" name="myform" method="post">
						查询条件: <select name="cond" style="width: 100px">
							<option value="roomsid">按宿舍查询</option>
							<option value="usersid">按学生查询</option>
							<option value="name">按访客姓名查询</option>
							<option value="reason">按来访原因查询</option>
							<option value="thestart">按开始时间查询</option>
							<option value="theend">按结束时间查询</option>
