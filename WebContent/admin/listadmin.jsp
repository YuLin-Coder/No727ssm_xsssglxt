				...
				<table id="dyntable" class="table table-bordered responsive">
					...
					<c:forEach items="${adminList}" var="admin">
						<tr style="text-align: center;">
							...
							<td style="text-align: center;"><c:if test="${admin.username ne 'admin' }">
									<a href="admin/getAdminById.action?id=${admin.adminid}">编辑</a>&nbsp;&nbsp;<a href="admin/deleteAdmin.action?id=${admin.adminid}"
