				...
				<div class="widget" style="width: 65%; margin: 0 auto;">
					...
					<div class="widgetcontent nopadding">
						<form class="stdform stdform2" method="post" action="banner/updateBanner.action" name="myform" method="post">
							...
							<p>
								<label>栏目名称</label><span class="field"><input type="text" name="bannername" class="input-xxlarge" style="width: 430px;"
									id="bannername" value="${banner.bannername}" /></span>
							</p>
							<p>
								<label>备注</label><span class="field"><input type="text" name="memo" class="input-xxlarge" style="width: 430px;" id="memo"
									value="${banner.memo}" /></span>
							</p>
