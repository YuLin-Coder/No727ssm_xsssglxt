	...
	<div class='main wid'>
		<div class='center_layout'>
			<h2>
				<span><i></i>我的报修</span>
				<p>
					<i></i>当前位置：<a href='index/index.action' style='color: #FFFFFF'>网站首页</a> > 我的报修
				</p>
			</h2>
			...
			<div class='ne-txt'>
				<div class='ne-form' align='center'>
					<table width="99%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
						<tr>
							<td height='30' colspan='9' align='left' background='themes/cms_red1/images/bg.png' class='white14B'>我的报修</td>
						</tr>
						<tr>
							<td align="center" bgcolor="#FFFFFF">报修单号</td>
							<td align="center" bgcolor="#FFFFFF">学生</td>
							<td align="center" bgcolor="#FFFFFF">宿舍</td>
							<td align="center" bgcolor="#FFFFFF">报修原因</td>
						...
						<c:forEach items="${brokenList}" var="broken">
							<tr align="center" bgcolor="#FFFFFF">
								<td>${broken.bno}</td>
								<td>${broken.username}</td>
								<td>${broken.roomsname}</td>
								<td>${broken.reason}</td>
								<td>${broken.addtime}</td>
								<td>${broken.status}</td>
								<td>${broken.memo}</td>
							</tr>
						</c:forEach>
